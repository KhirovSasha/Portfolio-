...
const Data = () => {
    return(
        <div className="home__data">
            ...
            <h3 className="home__subtitle">.NET Developer</h3>
            <p className="home__description">I`m creative interesting projects in Ukraine, Rivne.
             And I`am very meticulous and dedicated to my work.</p>
